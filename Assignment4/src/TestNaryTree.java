...
public class TestNaryTree {
	...
	public static void main(String[] args) {
		...
		//System.out.println(iTree.getRoot().toString());
		//System.out.println(iRoot.toString());
		//System.out.println("SIZE  "+  iTree.size(iTree.getRoot()));
		//System.out.println("TEST 2 MAX DEPTH  "+iTree.maxDepth(iTree.getRoot()));
		...
		LinkedNaryTree<String> sTree1 = new LinkedNaryTree<String>(sRoot);
		
		sRoot.addChild(c1);
		sRoot.addChild(c2);
		sRoot.addChild(c3);
		sRoot.addChild(c4);
		sTree1 = new LinkedNaryTree<String>(sRoot);
		//System.out.println("Round 1  "+sTree1.size(sTree1.getRoot()));
		...
		c1.addChild(n3);
		c1.addChild(n4);
		LinkedNaryTree<String> sTree2 = new LinkedNaryTree<String>(sRoot);
		sTree2 = new LinkedNaryTree<String>(sRoot);
		//System.out.println("Round 2  "+sTree2.size(sTree2.getRoot()));
		
		//System.out.println("Round 2  "+sTree.size(sTree.getRoot()));
		c2.addChild(n5);
		c2.addChild(n6);
		c2.addChild(n7);
		
		LinkedNaryTree<String> sTree3 = new LinkedNaryTree<String>(sRoot);
		sTree3 = new LinkedNaryTree<String>(sRoot);
		//System.out.println("Round 3  "+sTree3.size(sTree3.getRoot()));
		//System.out.println("Round 3  "+sTree.size(sTree.getRoot()));
		c3.addChild(n8);
		c3.addChild(n9);
		c3.addChild(n10);
		c3.addChild(n11);
		c3.addChild(n12);
		//System.out.println("Round 4  "+sTree.size(sTree.getRoot()));
		c4.addChild(n13);
		c4.addChild(n14);
		c4.addChild(n15);
		//System.out.println("Round 5  "+sTree.size(sTree.getRoot()));
		n1.addChild(t1);
		n9.addChild(t2);
		n9.addChild(t3);
		n11.addChild(t4);
		...
		//System.out.println("TEST 4  "+sTree.size(sTree.getRoot()));
		//System.out.println("TEST 4 MAX DEPTH  "+sTree.maxDepth(sTree.getRoot()));

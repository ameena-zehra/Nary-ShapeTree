...
public class TestShapeTree {
	...
	public static void main(String[] args) {
		...
		//System.out.println("NODE GET CHILD"+node.getChild(1).getData());
		if (!status) {
		...
		//tree.checkNode(node, null)
		//printTree(tree);
		
		seq = getSequence(tree);
		//System.out.println(seq);
		//System.out.println("1 blue 3 red 5 yellow 3 blue 1 green 4 purple ");
		...
		tree.addShapeNode(new Shape("square", "red"));
		//seq = getSequence(tree);
		//System.out.println("AFTER TRIANGLE"+seq);
		...
		seq = getSequence(tree);
		//System.out.println(seq);
		node = new NaryTreeNode<Shape>(new Shape("square", "red"));
		status = tree.checkNode(node, new Shape("triangle", "purple"));
		//System.out.println("PRINTING OUT STATUS:   "+ status);
